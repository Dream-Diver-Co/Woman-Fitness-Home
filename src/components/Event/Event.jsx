  ...
  const [events, setEvents] = useState([
    {
      ...
      description: "",
      image: event1,
      startDate: new Date("Mar 15, 2024").toDateString(),
      endDate: new Date("Aug 18, 2024").toDateString(),
    },
    {
      id: 2,
      ...
      description: "",
      image: event2,
      startDate: new Date("May 20, 2024").toDateString(),
      endDate: new Date("May 25, 2024").toDateString(),
    },
    {
      id: 3,
